...
public class App {
        ...
        public static void stack(Context ctx) {
                ...
                for (int i = 1; i <= 3; i++) {
                        ...
                        Subnet publicSubnet = new Subnet("PublicSubnet" + i, SubnetArgs.builder()
                                        .availabilityZone(available
                                                        .applyValue(getAvailabilityZonesResult -> getAvailabilityZonesResult
                                                                        .names().get(t)))
                        ...
                        var routeTableAssociationArgsPub = new RouteTableAssociation("RouteTableAssociationPub" + i,
                                        RouteTableAssociationArgs.builder().routeTableId(publicRouteTable.id())
                                                        .subnetId(publicSubnet.id())
                                                        .build());
                        // RouteTableAssociation routeTableAssociationPub = new
                        // RouteTableAssociation("publicRouteTableAssociationPub" + i,
                        // routeTableAssociationArgsPub);
                        ...
                        var routeTableAssociationArgsPriv = new RouteTableAssociation("RouteTableAssociationPriv" + i,
                                        RouteTableAssociationArgs.builder().routeTableId(privateRouteTable.id())
                                                        .subnetId(privateSubnet.id()).build());
                        // RouteTableAssociation routeTableAssociationPriv = new
                        // RouteTableAssociation("publicRouteTableAssociationPriv" + i,
                        // routeTableAssociationArgsPriv);
                ...
                SecurityGroup appSecurityGroup = new SecurityGroup("loadBalancerSecurityGroup",
                ...
                // SecurityGroup sg = new SecurityGroup("mySecurityGroup", new
                ...
                // Output<List<String>> ec2SecGrpOutput = Output.all(sg.id()).applyValue(ids ->
                // ids);
                ...
                Output<String> snsTopicOutput = mySnsTopic.arn().applyValue(ids -> ids);

                Output<String> script1 = dbpointOutput.applyValue(dbpoint -> {
                        // Output<String> mySnsTopicOutput = mySnsTopic.arn().applyValue(snsarn ->
                        // snsarn);
                        String script = "#!/bin/bash\n" +
                                        ...
                                        +
                                        "echo 'spring.datasource.url=jdbc:mysql://" + dbpoint + ":3306/" + databaseName
                                        + "' >> /home/admin/custom.properties\n" +
                                        "echo 'spring.datasource.username=" + databaseUser
                                        + "' >> /home/admin/custom.properties\n" +
                                        "echo 'spring.datasource.password=" + databasePassword
                                        + "' >> /home/admin/custom.properties\n" +
                        ...
                        script += snsTopicOutput
                                        .applyValue(srn -> "echo 'SNS_TOPIC_ARN=" + srn + "' >> /etc/environment\n");
                        return Base64.getEncoder().encodeToString(script.getBytes());
                });

                Output<String> script2 = dbpointOutput.apply(dbpoint -> snsTopicOutput.applyValue(snsTopicArn -> {
                        ...
                        String script = "#!/bin/bash\n" +
                                        ...
                                        "sudo systemctl start amazon-cloudwatch-agent\n" +
                                        "sudo systemctl enable amazon-cloudwatch-agent\n";
                        script += "echo 'SNS_TOPIC_ARN=" + snsTopicArn + "' >> /etc/environment\n";
                        return Base64.getEncoder().encodeToString(script.getBytes());
                }));
                ...
                RolePolicyAttachment snsPublish = new RolePolicyAttachment("SNSPublishPolicy",
                                RolePolicyAttachmentArgs.builder().role(instanceRole.name())
                                                .policyArn("arn:aws:iam::aws:policy/AmazonSNSFullAccess")
                                                .build());
                RolePolicyAttachment lambdaRolePolicy = new RolePolicyAttachment("AWSLambdaRolePolicy",
                                RolePolicyAttachmentArgs.builder().role(instanceRole.name())
                                                .policyArn("arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole")
                                                .build());

                Output<String> instanceRoleOutput = instanceRole.arn().applyValue(ids -> ids);
                ...
                String ami3 = "ami-0b341be9acd8da352";

                String key_pair = "csye6225";

                // Provider awsProvider = new Provider("aws",
                // ProviderArgs.builder().region("us-west-2").build());

                // Availability availabilityZones =
                // awsProvider.getAvailabilityZones(AvailabilityZonesArgs.builder().state("available").build());
                // // Use availability zones as needed String firstAvailabilityZone =
                // availabilityZones.names().apply(names -> names.get(0));

                // Get availability zones in current region
                // GetAvailabilityZonesResult availabilityZones =
                // aws.GetAvailabilityZones.invoke().apply(availabilityZoneResult ->
                // availabilityZoneResult);
                ...
                Output<List<String>> csye6225f23_ScalingGroupOutput = Output.all(csye6225f23_ScalingGroup.arn())
                                .applyValue(ids -> ids);
                ...
                // TargetGroup tg = new TargetGroup("exampleTargetGroup", new
                ...
                // .build()
                // );
                // Output<List<TargetGroupTargetHealthState>> targetHealths =
                // tg1.targetHealthStates();

                com.pulumi.aws.alb.TargetGroup tg1 = new com.pulumi.aws.alb.TargetGroup("TargetGroup",
                                com.pulumi.aws.alb.TargetGroupArgs.builder()
                                                ...
                                                // .enableUnhealthyConnectionTermination(true)
                                                // .build()))
                                                .healthCheck(com.pulumi.aws.alb.inputs.TargetGroupHealthCheckArgs
                                                                .builder()
                                                                .path("/")
                                                                .protocol("HTTP")
                                                                .healthyThreshold(5)
                ...
                // LoadBalancer apploadBalancer = new LoadBalancer("webappLoadBalancer",
                ...
                com.pulumi.aws.alb.LoadBalancer apploadBalancer1 = new com.pulumi.aws.alb.LoadBalancer(
                                "webappLoadBalancer",
                ...
                com.pulumi.aws.alb.Listener httpl = new com.pulumi.aws.alb.Listener("Listener",
                                com.pulumi.aws.alb.ListenerArgs.builder()
                                                .loadBalancerArn(apploadBalancer1.arn())
                                                .port(80)
                                                .protocol("HTTP")

                                                .defaultActions(com.pulumi.aws.alb.inputs.ListenerDefaultActionArgs
                                                                .builder()
                                                                .type("forward")
                ...
                // Output<List<String>> ec2instanceList =
                // Output.all(ec2Instance.publicIp()).applyValue(publicIp -> publicIp);
                ...
                com.pulumi.gcp.storage.Bucket existingBucket = com.pulumi.gcp.storage.Bucket.get("existing_bucket",
                                existingBucketNameOutput, null, null);

                com.pulumi.gcp.serviceAccount.Account gcpServiceAccount = new com.pulumi.gcp.serviceAccount.Account(
                ...
                com.pulumi.gcp.serviceAccount.Key gcpServiceAccountKey = new com.pulumi.gcp.serviceAccount.Key(
                                "myServiceAccount", com.pulumi.gcp.serviceAccount.KeyArgs.builder()
                ...
                var bucketAdminBinding = new BucketIAMBinding("bucketAdminBinding", BucketIAMBindingArgs.builder()
                                .bucket(existingBucket.name()) // Replace with the actual bucket name or reference
                                .role("roles/storage.objectAdmin")
                                .members("user:aditya.3342@gmail.com")
                                .build());
                ...
                com.pulumi.gcp.projects.IAMCustomRole gcpRole = new com.pulumi.gcp.projects.IAMCustomRole("gcpRole",
                ...
                // com.pulumi.gcp.projects.IAMPolicy gcpPolicy = new
                // com.pulumi.gcp.projects.IAMPolicy("gcpPolicy",com.pulumi.gcp.projects.IAMPolicyArgs.builder()
                // .project("academic-osprey-406507")
                // .policyData(Output.format("{\"bindings\":[{\"role\":\"%s\",\"members\":[\"user:aditya.3342@gmail.com\"]}]}",
                // gcpRole.name()))
                // .build()
                // );
                ...
                Role lambdaRole = new Role("lambdaRole",
                                RoleArgs.builder().assumeRolePolicy(
                ...
                var policyAttachment = new RolePolicyAttachment("policyAttachment", RolePolicyAttachmentArgs.builder()
                                ...
                                .policyArn(policyArn)
                                .build());
                RolePolicyAttachment snsPublish1 = new RolePolicyAttachment("SNSPublishPolicyLambda",
                                RolePolicyAttachmentArgs.builder().role(lambdaRole.name())
                                                .policyArn("arn:aws:iam::aws:policy/AmazonSNSFullAccess")
                                                .build());

                RolePolicyAttachment cloudWatchPolicylambda = new RolePolicyAttachment("CloudWatchPolicylambda",
                                RolePolicyAttachmentArgs.builder().role(lambdaRole.name())
                                                .policyArn("arn:aws:iam::aws:policy/CloudWatchAgentServerPolicy")
                                                .build());
                RolePolicyAttachment dynamoDbPolicy = new RolePolicyAttachment("dynamoDbPolicy",
                                RolePolicyAttachmentArgs.builder().role(lambdaRole.name())
                                                .policyArn("arn:aws:iam::aws:policy/AmazonDynamoDBFullAccess")
                                                .build());
                Output<String> lambdaRoleOutput = lambdaRole.arn().applyValue(ids -> ids);
                // Role awsLambdaFunctionRole = new Role("awslambdaRole", RoleArgs.builder()

                // .build());
                Output<String> sKeyOutput = gcpServiceAccountKey.privateKey().applyValue(ids -> ids);
                Output<Map<String, String>> environmentSecretso = sKeyOutput.apply(skey1 -> dynamoDbTableOutput
                                .apply(dynamodb -> snsTopicOutput.applyValue(i -> {
                                        Map<String, String> environmentSecrets = new HashMap<>();
                                        environmentSecrets.put("GOOGLE_ACCESS_KEY", skey1);
                                        environmentSecrets.put("BUCKET_NAME", existingBucketName);
                                        environmentSecrets.put("SNS_TOPIC_ARN", i);
                                        environmentSecrets.put("apiKey",
                                                        "43e5d8633e655a4bcbbffe65a26a8a79-30b58138-4ee208cd");
                                        environmentSecrets.put("domain", "adityaraj-2703.me");
                                        environmentSecrets.put("dynamoTable", dynamodb);

                                        return environmentSecrets;
                                })));

                // Output<Map<String, String>> environmentSecretsOutput =
                // Output.of(environmentSecretso);

                Output<String> deployedURL = Output.of("https://github.com/adityaraj-270301/serverless.git");

                com.pulumi.gcp.cloudfunctions.Function lambdaFunction = new com.pulumi.gcp.cloudfunctions.Function(
                                "lambdaFunction", com.pulumi.gcp.cloudfunctions.FunctionArgs.builder()
                                                .project("academic-osprey-406507")
                                                .region("us-east1")
                                                .runtime("nodejs14")
                                                ...
                                                // .build()
                                                // )
                                                .httpsTriggerUrl(deployedURL)
                                                .sourceArchiveBucket(existingBucketName)
                                                .sourceArchiveObject(
                                                                "/Users/adityaraj/Documents/CSYE6225 Network Structures & Cloud Computing/serverless-l.zip")
                                                .entryPoint("index.js")
                                                .triggerHttp(true)
                                                // .environmentVariables(environmentSecretsOutput)
                                                .build());

                var fileArchive = new com.pulumi.asset.FileArchive(
                                "/Users/adityaraj/Documents/CSYE6225 Network Structures & Cloud Computing/serverless-l/Archive.zip");
                AssetArchive a11 = new AssetArchive(Map.of(
                                "file", new com.pulumi.asset.StringAsset("Hello, world!")));
                Function lambdaFunction2 = new Function("LambdaFunction1", FunctionArgs.builder()
                                .runtime("nodejs14.x")
                                .packageType("Zip")
                                .role(lambdaRoleOutput)
                                .code(fileArchive)
                                .handler("index.handler")

                                .environment(FunctionEnvironmentArgs.builder()
                                                .variables(environmentSecretso)
                                                .build())
                                .build());
                var snsSubscription = new TopicSubscription("snsSubscription", TopicSubscriptionArgs.builder()
                                .endpoint(lambdaFunction2.arn()) // Endpoint ARN for the Lambda function
                                .protocol("lambda") // Protocol to trigger the Lambda function
                                .topic(mySnsTopic.arn()) // ARN of the SNS Topic
                                .build());
                var lambdaPermission = new Permission("lambdaPermission",
                                PermissionArgs.builder()
                                                .action("lambda:InvokeFunction")
                                                .function(lambdaFunction2.arn())
